...
function createTail() {
	...
	var textureTail =  THREE.ImageUtils.loadTexture( 'media/img/cs291/textures/feather.png' );
	
	var tail = new THREE.Mesh(
		new THREE.PlaneGeometry( 100, 100, 1, 1 ),
		new THREE.MeshBasicMaterial( { map: textureTail, side: THREE.DoubleSide, transparent: true } ) );
