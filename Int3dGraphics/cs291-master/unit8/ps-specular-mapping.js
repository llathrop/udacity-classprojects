...
function createMaterial() {
	...
	var textureWater =  THREE.ImageUtils.loadTexture( 'media/img/cs291/textures/water.jpg' );
	
	var material = new THREE.MeshPhongMaterial( { specularMap: textureWater, shininess: 50, side: THREE.DoubleSide} );
