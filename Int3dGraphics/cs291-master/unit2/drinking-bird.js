...
function createBody() {
	...
	neck.position.x = 0;	
	neck.position.y = 52+334;	
	neck.position.z = 0;	// centered at origin
	scene.add( neck );	
...
function createHead() {
	...
	var hatBrim;
	hatBrim = new THREE.Mesh(
		new THREE.CylinderGeometry( 142/2, 142/2, 10, 32 ) , cylinderMaterial );
	hatBrim.position.x = 0;	// (20+32) - half of width (20+64+110)/2
	hatBrim.position.y = 160+390+40+10;	// half of height
	hatBrim.position.z = 0;	// centered at origin
	scene.add( hatBrim );	

	
	var hatTop;
	hatTop = new THREE.Mesh(
		new THREE.CylinderGeometry( 80/2, 80/2, 70, 32 ) , cylinderMaterial );
	hatTop.position.x = 0;	// (20+32) - half of width (20+64+110)/2
	hatTop.position.y = 160+390+40+10+70/2;	// half of height
