...
function createBall() {
	...
	var newRed = material.color.r ;
	var newBlue = material.color.b ;
	var newGreen = material.color.g ;
	
	material.color.setRGB(newRed,newGreen, newBlue);
	material.ambient.setRGB(newRed*.4,newGreen*.4,newBlue*.4);
