...
function init() {
	...
	// front OrthographicCamera( left, right, top, bottom, near, far )
	...
	// side OrthographicCamera( left, right, top, bottom, near, far )
...
function render() {
	...
	renderer.setViewport( 0.5*0, 0.5*canvasHeight, 0.5*canvasWidth, 0.5*canvasHeight );
	...
	renderer.setViewport( 0.5*canvasWidth, 0.5*0, 0.5*canvasWidth, 0.5*canvasHeight );
